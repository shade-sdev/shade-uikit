...
export const APP_PERMISSIONS = {
  ...
  metricFormulas: {
    view: [
      'METRIC_FORMULA_MINE_READ',
      'METRIC_FORMULA_OTHER_READ',
      'METRIC_FORMULA_MINE_MANAGEMENT',
      'METRIC_FORMULA_OTHER_MANAGEMENT',
    ],
    create: [
      'METRIC_FORMULA_MINE_CREATE',
      'METRIC_FORMULA_OTHER_CREATE',
      'METRIC_FORMULA_MINE_MANAGEMENT',
      'METRIC_FORMULA_OTHER_MANAGEMENT',
    ],
    edit: [
      'METRIC_FORMULA_MINE_UPDATE',
      'METRIC_FORMULA_OTHER_UPDATE',
      'METRIC_FORMULA_MINE_MANAGEMENT',
      'METRIC_FORMULA_OTHER_MANAGEMENT',
    ],
    delete: [
      'METRIC_FORMULA_OTHER_MANAGEMENT',
      'METRIC_FORMULA_MINE_MANAGEMENT',
      'METRIC_FORMULA_MINE_DELETE',
      'METRIC_FORMULA_OTHER_DELETE',
    ],
  },
