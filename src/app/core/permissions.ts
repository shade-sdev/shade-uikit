...
export const APP_PERMISSIONS = {
  ...
  trainingSessions: {
    view: [
      'TRAINING_SESSION_MINE_READ',
      'TRAINING_SESSION_OTHER_READ',
      'TRAINING_SESSION_MINE_MANAGEMENT',
      'TRAINING_SESSION_OTHER_MANAGEMENT',
    ],
    create: [
      'TRAINING_SESSION_MINE_CREATE',
      'TRAINING_SESSION_OTHER_CREATE',
      'TRAINING_SESSION_MINE_MANAGEMENT',
      'TRAINING_SESSION_OTHER_MANAGEMENT',
    ],
    edit: [
      'TRAINING_SESSION_MINE_UPDATE',
      'TRAINING_SESSION_OTHER_UPDATE',
      'TRAINING_SESSION_MINE_MANAGEMENT',
      'TRAINING_SESSION_OTHER_MANAGEMENT',
    ],
    delete: [
      'TRAINING_SESSION_OTHER_MANAGEMENT',
      'TRAINING_SESSION_MINE_MANAGEMENT',
      'TRAINING_SESSION_MINE_DELETE',
      'TRAINING_SESSION_OTHER_DELETE',
    ],
  },
